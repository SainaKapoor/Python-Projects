...
def getInput():
    ...
    ep = float(input("The potential energy of the ball: "))
    while u<0:
        print("The potential energy has to be a positive number")
        ep = float(input("The potential energy of the ball: "))
    
   
    return initial_height,u,ep
    ...
    for step_time in np.arange(0, 401, 1):
        ...
        if ball_falling == True:    #Scenario for falling ball
            ...
            if present_height<=0:
                ...
                v1 = v1*math.sqrt(1-ep)
                
                print("B:")
                print(" The speed is: ", v1)
                print("The total number oftimesteps taken are: ", step_time)
